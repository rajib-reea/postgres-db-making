--drop table if exists "acc_recurring_bills" cascade;
...
--drop table if exists "acc_recurring_bill_items" cascade;
CREATE TABLE IF NOT EXISTS "acc_recurring_bill_items" (
	"id" serial,
  	"sid" varchar(255) not null default '',
  	"udid" varchar(255) not null default '',
	"iid" integer not null default 0,
